Locales['en'] = {
    ...
    delivery_menu_title = "Delivery Menu",
    order_abandoned = "Order abandoned",
    no_active_order_label = "Active order: None",
    abandon_order = "Abandon order",
    available_orders_label = "Available orders",
    unavailable_orders_label = "Unavailable orders",
    no_unavailable_orders = "No unavailable orders",
    remove_warehouse = "Remove selected warehouse",
    warehouse_blip_removed = "Warehouse blip removed",
    ...
    loss = 'You lost $%s from this order!',
